      ...
      <div className="w-full max-w-sm">
        ...
        <div className="rounded-lg border border-[var(--border-subtle)] bg-[var(--bg-surface)] p-8">
          <div className="mb-6 text-center">
            ...
            <p className="mt-1 text-sm text-[var(--text-secondary)]">Get started with SkySend for free</p>
          </div>
          ...
          <p className="mt-4 text-center text-xs text-[var(--text-tertiary)]">
            ...
            {' '}and{' '}
            <a href="#" className="text-[var(--text-secondary)] hover:text-[var(--text-primary)]">Privacy Policy</a>
          </p>
