        ...
        <div className="relative z-10">
          ...
          <div className="mt-12 space-y-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                <p className="font-semibold text-[var(--bg-app)]">5-minute setup</p>
                <p className="mt-1 text-sm text-[var(--bg-app)]/60">Connect your email, import contacts, and launch</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <p className="font-semibold text-[var(--bg-app)]">Enterprise-grade security</p>
                <p className="mt-1 text-sm text-[var(--bg-app)]/60">SOC 2 compliant with end-to-end encryption</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <p className="font-semibold text-[var(--bg-app)]">Unlimited integrations</p>
                <p className="mt-1 text-sm text-[var(--bg-app)]/60">Connect with HubSpot, Salesforce, Pipedrive, and more</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="relative z-10 mt-auto pt-12">
          <div className="rounded-2xl bg-[var(--bg-app)]/10 backdrop-blur-sm p-6 border border-[var(--bg-app)]/10">
            ...
            <div className="mt-4 flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-medium text-[var(--bg-app)]">Marcus Kim</p>
                <p className="text-xs text-[var(--bg-app)]/60">Head of Growth, ScaleUp.io</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="flex w-full lg:w-1/2 items-center justify-center bg-[var(--bg-app)] px-6 py-12">
        <div className="w-full max-w-[420px]">
          ...
          <p className="mt-8 text-center text-sm text-[var(--text-secondary)]">
            ...
            <Link to="/login" className="font-semibold text-[var(--text-primary)] hover:text-[var(--text-secondary)] transition-colors">
              Sign in
            </Link>
          </p>
        </div>
