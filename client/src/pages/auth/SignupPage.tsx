...
export function SignupPage() {
  ...
  return (
    <div className="flex min-h-screen bg-surface-600">
      ...
      <div className="hidden lg:flex lg:flex-1 bg-gradient-to-br from-indigo-900 via-indigo-950 to-slate-900 relative overflow-hidden">
        {/* Gradient orbs */}
        ...
        <div className="relative z-10 flex flex-col justify-center p-12 text-white">
          <div className="max-w-lg">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 border border-white/10 backdrop-blur-sm mb-8">
              ...
              <span className="text-sm font-medium text-slate-200">Start free, upgrade anytime</span>
            </div>
      ...
      <div className="flex flex-1 flex-col justify-center px-8 py-12 lg:px-12">
        <div className="mx-auto w-full max-w-md">
          {/* Auth Card */}
          <div className="bg-slate-800/50 border border-slate-800 rounded-xl p-8">
            {/* Logo */}
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    className="w-full h-12 rounded-xl border border-slate-700 bg-slate-800/50 pl-12 pr-4 text-white placeholder:text-slate-500 focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 transition-all duration-200"
                  />
                </div>
              </div>
            ...
            <div className="relative my-8">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="bg-slate-800/50 px-4 text-slate-400">Or sign up with</span>
              </div>
            </div>
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 h-12 rounded-xl border border-slate-700 bg-slate-800 text-white font-medium hover:bg-slate-700 hover:border-slate-600 transition-all duration-200"
            >
