    ...
    <a className="lp-header__logo" href="/" style={{ textDecoration: 'none' }}>
      <span className="lp-header__logo-mark">
        <svg width="28" height="28" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <linearGradient id="md-auth-mark" x1="4" y1="6" x2="36" y2="34" gradientUnits="userSpaceOnUse">
              <stop stopColor="#8A4DFC" /><stop offset="1" stopColor="#2A71FC" />
            </linearGradient>
          </defs>
          <path d="M7 31 16 9 24 27 33 11" stroke="url(#md-auth-mark)" strokeWidth="6.4" strokeLinecap="round" strokeLinejoin="round" />
